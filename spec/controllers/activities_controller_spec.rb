...
RSpec.describe ActivitiesController, type: :controller do
  ...
  let(:valid_attributes) {
    build(:activity).attributes.except("id", "created_at", "updated_at")
  }

  let(:invalid_attributes) {
    build(:invalid_activity).attributes.except("id", "created_at", "updated_at")
  }
  ...
  describe "PUT #update" do
    ...
    context "with valid params" do
      ...
      it "updates the requested activity" do
        ...
        activity.reload
        expect(activity.attributes.fetch_values(*new_attributes.keys)).to be == new_attributes.values
      end
