...
RSpec.describe PlacesController, type: :controller do
  ...
  let(:valid_attributes) {
    build(:place).attributes.except("id", "created_at", "updated_at")
  }

  let(:invalid_attributes) {
    build(:invalid_place).attributes.except("id", "created_at", "updated_at")
  }
  ...
  describe "PUT #update" do
    ...
    context "with valid params" do
      ...
      it "updates the requested place" do
        ...
        place.reload
        expect(place.attributes.fetch_values(*new_attributes.keys)).to be == new_attributes.values
      end
