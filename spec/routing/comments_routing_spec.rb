...
RSpec.describe CommentsController, type: :routing do
  describe "routing" do
    ...
    it "routes to #index" do
      expect(:get => "/users/1/comments").to route_to("comments#index", user_id: '1')
    end

    it "routes to #new" do
      expect(:get => "/users/1/comments/new").to route_to("comments#new", user_id: '1')
    end
    ...
    it "routes to #create" do
      expect(:post => "/users/1/comments").to route_to("comments#create", user_id: '1')
    end
